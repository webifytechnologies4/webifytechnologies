...
const ProjectsSection = () => {
  return (
    <section className="relative overflow-hidden bg-white py-8">
      {/* Background Glow */}
      <div className="absolute top-0 left-0 h-[450px] w-[450px] rounded-full bg-blue-100 blur-3xl opacity-70" />
      <div className="absolute bottom-0 right-0 h-[400px] w-[400px] rounded-full bg-sky-100 blur-3xl opacity-70" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-0">
        ...
        >
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-5 py-2">
          ...
          <p className="mx-auto mt-6 max-w-6xl text-lg leading-relaxed text-gray-900">
          ...
          {projects.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -14 }}
                className="group relative overflow-hidden rounded-lg border border-gray-300 bg-white shadow-xl shadow-black/50 transition duration-500"
              >
                {/* Hover Glow */}
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-6 left-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/20 bg-white/20 backdrop-blur-xl"
                  >
                    <Icon size={30} className="text-white" />
                  </motion.div>

                  {/* Tag */}
                  <div className="absolute top-5 right-5 rounded-full bg-white/80 px-6 py-2 text-xs font-bold uppercase tracking-wider text-blue-700 backdrop-blur-xl">
                    Premium
                  </div>
                </div>
                ...
                <div className="relative p-8">
                  <h3 className="text-2xl font-black text-gray-900 transition duration-300 group-hover:text-blue-700">
                    {project.title}
                  </h3>
                  ...
                  <motion.button
                    whileHover={{ x: 5 }}
                    className="mt-7 flex items-center gap-3 font-semibold text-blue-700"
                  >
                    View Project
                    <ArrowRight
                      size={18}
